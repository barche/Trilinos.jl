...
function buildgraph(comm, grid)
  ...
  if my_rank == 0
    ...
    display(systogrid')
    println()
    println("systogrid local part:")
    forlocalpart(systogrid) do lp
      display(lp')
    end
    println()
  end
  ...
  if my_rank == 0
    println("filtered systogrid:")
    display(systogrid')
    println()
    println("filtered systogrid local part:")
    forlocalpart(systogrid) do lp
      display(lp')
    end
    println()
  ...
  if my_rank == 0
    println("redistributed systogrid:")
    display(systogrid')
    println()
    println("redistributed systogrid local part:")
    forlocalpart(systogrid) do lp
      display(lp')
    end
    println()
  ...
  if my_rank == 0
    ...
    display(gridtosys')
    println()
    println("gridtosys local part:")
    forlocalpart(gridtosys) do lp
      display(lp')
    end
    println()
  end
  ...
  if my_rank == 0
    println("graph rowmap:")
    display(staticgraph.rowmap')
    println()
    println("graph entries:")
    display(staticgraph.entries')
    println()
  end
  ...
  if my_rank == 0
    println("gridtosys with ghosts")
    display(gridghosts')
    println()
    println("gridtosys global grid IDs")
    display(globalids(gridghosts)')
    println()
  end
  ...
  if my_rank == 0
    println("system graph rowmap:")
    display(staticgraph.rowmap')
    println()
    println("system graph entries:")
    display(staticgraph.entries')
    println()
  end
  ...
  if my_rank == 0
    println("systogrid with ghosts")
    display(sysghosts')
    println()
    println("systogrid global grid IDs")
    display(globalids(sysghosts)')
    println()
  end
  ...
  if my_rank == 0
    println("local system graph rowmap:")
    display(staticgraph.rowmap')
    println()
    println("local system graph entries:")
    display(staticgraph.entries')
    println()
  end
...
function laplace2d(comm, grid)
  ...
  solver_params["Verbosity"] = Belos.Errors
